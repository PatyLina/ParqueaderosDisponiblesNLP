...
app.get('/parkings/request', (request, response) => {    
...
const options = {
  key: fs.readFileSync(path.join(__dirname, 'certificados', 'clave-privada.key')),
  cert: fs.readFileSync(path.join(__dirname, 'certificados', 'certificado-firmado.crt'))
};
